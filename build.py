...
def write_readme() -> None:
    ...
    readme.write_text(
        ...
        "  whole line.  Pick one with Up/Down and press Tab to put it in.\n"
        "  Turn the individual parts on or off in Settings -> Suggest.\n\n"
        ...
        "  (Left/Right still move the text cursor as normal.)\n"
