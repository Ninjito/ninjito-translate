...
def write_readme() -> None:
    ...
    readme.write_text(
        ...
        "  4. Press F7 (or the Translate button) whenever you want to\n"
        ...
        "TYPING SUGGESTIONS:\n"
        "  While you type in Dota's own chat box, a small popup shows\n"
        "  better words: spelling fixes, completions so you don't have to\n"
        "  finish a long word, and a grammar-corrected version of the\n"
        "  whole line.  Pick one with Up/Down, then press Left or Right\n"
        "  to put it in.  Turn the individual parts on or off in\n"
        "  Settings -> Suggest.\n\n"
        "  Word fixes and completions work offline.  The whole-sentence\n"
        "  grammar fix needs internet.\n\n"
        "CONTROLS:\n"
        "  F7                     - Translate chat right now\n"
        "  Ctrl + Shift + V       - Toggle voice translation on/off\n"
        "  -- while the suggestion popup is showing --\n"
        "  Up / Down arrow        - Choose a suggestion\n"
        "  Left / Right arrow     - Insert the selected suggestion\n"
        "  ESC                    - Close the popup (chat stays open)\n"
        "  (With no popup showing, the arrows and Tab behave exactly\n"
        "   as they normally do in Dota.)\n"
        ...
        "  * No typing suggestions - Settings -> Suggest shows why. If it\n"
        "                           says 'access denied', Dota is running\n"
        "                           as administrator and this app isn't;\n"
        "                           right-click the EXE -> Run as\n"
        "                           administrator.\n"
